...
import com.example.travllingapp.databinding.ActivityForestActivtyBinding
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.storage.FirebaseStorage
import com.google.firebase.storage.StorageReference
import java.util.UUID

class forestActivty : AppCompatActivity() {
    lateinit var binding: ActivityForestActivtyBinding
    private val PICK_IMAGE_REQUEST = 100
    lateinit var uri: Uri
    lateinit var ImageUri: Uri
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityForestActivtyBinding.inflate(layoutInflater)
