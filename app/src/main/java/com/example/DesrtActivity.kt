...
class DesrtActivity : AppCompatActivity() {
    lateinit var binding: ActivityDesrtBinding
    private val PICK_IMAGE_REQUEST = 100
    lateinit var uri: Uri
    lateinit var ImageUri: Uri
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDesrtBinding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.btnselectimag.setOnClickListener {
            ...
            binding.BtnAdd.setOnClickListener {
                ...
                var key = reference.root.child("DesrtTb").push().key ?: ""
                ...
                reference.root.child("DesrtTb").child(key).setValue(modelClass)
